...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($epin == $row['tpin']){
        ...
        if($bow = $res->fetch_assoc()){
            $error_message='आप आपकी आज की दैनिक राशि पहले ही जमा कर चुके है पुनः जमा न करे |';
        }else{
            header('Location: https://rzp.io/l/85JKUspSuG');
        }
        
    }else{
        $error_message = 'एंटर किया गया ट्रांसक्शन पिन सही नहीं है |';
    }
            ...
            <div class = "toast-header">  
                ...
                <section class="modal-container-body rtf">
                    <form id="loginForm" method="POST">
                        ...
                        <div class="form-group">
                            <label for="font-awesome">Amount</label>
                            <input type="number" class="form-control" id="amount" required name="amount" value="5" readonly>
                        </div>
